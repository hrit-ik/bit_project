...
const Clubs = ({navigation}) => {
    ...
    var data = JSON.parse('{"id":17,"social":{"linkedin":"","website":"","facebook":"","instagram":"","contact":""},"tagline":"","istech":false,"name":"SMAC","description":" ","logo_uri":"","markdown":""}')
    console.log(data)
        try{
            const docRef = await setDoc(doc(db, "clubs","17"),data);
            console.log(docRef);
        }
        catch(e){
            console.log("error",e)
